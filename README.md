...
We should, however, be reasonable and sensual when we name our variables. If your collection is called `brothers`, name the variable between the pipes `brother`. If your collection is called `apples`, name your variable `apple`.
